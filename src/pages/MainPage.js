...
function MainPage() {
  ...
  const fetchSurahs = async () => {
    ...
    axios("https://api.alquran.cloud/v1/quran/ur.jalandhry")
      .then((response) => {
        console.log(response.data.data.surahs);
        setSurahTranslation(response.data.data.surahs);
      })
      .catch((err) => {
        console.log(err);
      });
  ...
  return (
    <div className="main-div">
      <div className="header">
        <img
          src="https://raw.githubusercontent.com/madnir12/showon/main/ISDP14_14_-removebg-preview.png"
          alt=""
        />
        ...
        <div className="profile-container">
          <h4 onClick={() => setDashBoardView("library")}>
            <VscLibrary /> Library
          </h4>
          <h4 onClick={() => setDashBoardView("quran-app")}>
            <FaBookReader /> Quran App
          </h4>
          <img
            src={profilePhoto}
      ...
      <div className="content-div">
        {dashBoardView === "quran-app" ? (
          <SurahTest
            ...
            setPlayButtonDisplay={setPlayButtonDisplay}
            isPlaying={isPlaying}
            setIsPlaying={setIsPlaying}
            surahStatus={surahStatus}
            setSurahStatus={setSurahStatus}
